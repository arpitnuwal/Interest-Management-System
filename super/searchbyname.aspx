<%@ Page Title="" Language="C#" MasterPageFile="~/super/Admin.master" AutoEventWireup="true" CodeFile="searchbyname.aspx.cs" Inherits="searchbyname" %>
                        ...
                        <div class="row">
                               ...
                               <div class="col-md-10">
                                <div class="form-group has-success">
                                    ...
                                    <asp:TextBox ID="txtname" runat="server" class="form-control" AutoComplete="off"></asp:TextBox>
                                     
                                </div>
                            </div>
                            
                            
                            <div class="col-md-0" runat="server" visible="false">
                                <div class="form-group has-success">
                                        ...
                                        <ItemTemplate>
                                            <tbody>
                                                ...
                                                <tr class="<%#Convert.ToString(setclass(Convert.ToBoolean(Eval("status")))) %>">
                                                    ...
                                                    <td>
                                                        <a href="userdata.aspx?id=<%#Eval("id") %>&&word=<%=word %>">Detail</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </ItemTemplate>
