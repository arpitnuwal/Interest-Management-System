<%@ Page Title="" Language="C#" MasterPageFile="~/super/Admin.master" AutoEventWireup="true" CodeFile="userupdate.aspx.cs" Inherits="userupdate" %>
                    ...
                    <div class="panel-heading">
                        Customer Forms
                                                ...
                                                <asp:Button ID="Button1" runat="server" Class="btn btn-danger" Text="Submit"  Style="border-style: none;background-color:#2c8bb6; padding: 5px" OnClick="Button1_Click" />
                                                                    <asp:Button ID="Button2" runat="server" Class="btn btn-danger" Text="delete"  Style="border-style: none;background-color:#2c8bb6; padding: 5px;margin-left:900px" OnClick="Button2_Click" />
                        ...
                        <form role="form">
                             ...
                             <div class="col-md-2" runat="server" visible="false">
                              ...
                              <div class="col-md-1" runat="server" visible="false">
                                <div class="form-group has-success">
                                    ...
                                    <asp:TextBox ID="txtinterestrate"  Text="2"   runat="server"  class="form-control" ></asp:TextBox>
                            ...
                            <div class="col-md-1" runat="server" visible="false">
                                <div class="form-group has-success">
                                    ...
                                    <asp:TextBox ID="txtKistNumber"   Text="10"   runat="server" onkeypress='return ((event.charCode >= 48 && event.charCode <= 57)||event.keyCode == 8||event.keyCode == 9)' class="form-control"></asp:TextBox>
                            ...
                            <div class="col-md-12">
                                <div class="form-group has-success">
                                    ...
                                    <asp:TextBox ID="txtaddress"  runat="server" class="form-control" Style="font-size:13px;text-transform: uppercase;"  TextMode="MultiLine"  Rows="35"></asp:TextBox>
                             ...
                             <div id="Div1" class="col-md-3" runat="server" visible="true"><div class="form-group has-success"><label class="control-label" for="success">Customer Photo</label><asp:FileUpload ID="customerphoto" class="form-control" runat="server" /><asp:Image ID="Image1" runat="server"  Height="100" Width="100"  /></div></div><div id="Div2" class="col-md-3" runat="server" visible="true"><div class="form-group has-success"><label class="control-label" for="success">Photo Other</label><asp:FileUpload ID="aadharphoto" class="form-control" runat="server" /><asp:Image ID="Image2" runat="server"  Height="100" Width="100"/></div></div>
                          
                              <div id="Div3" class="col-md-8"  runat="server" visible="false">
